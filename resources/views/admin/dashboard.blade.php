            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-footer">
                  ...
                  <a href="{{ url('logout')}} " class="btn btn-default btn-flat float-end bg-primary-hover">Sign out</a>
                </li>
                <!--end::Menu Footer-->
              </ul>
            </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hello <span class="text-success">{{Auth::user()->first_name}}</span> you're welcome!!</h3></div>
              <div class="col-sm-6">
